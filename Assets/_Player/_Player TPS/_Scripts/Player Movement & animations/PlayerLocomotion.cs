...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if(animatorHandler) animatorHandler.Initialize();
    ...
    public void HandleFalling(float delta, Vector3 moveDirection)
    {
        ...
        if (Physics.SphereCast(origin, 0.2f, -Vector3.up, out hit, minimumDistanceNeededToBeginFall, ignoreForGroundCheck))
        {
